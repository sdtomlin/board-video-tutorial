...
export const BoardCard = ( { id, title, authorName, authorId, createdAt, orgId, isFavourite }:BoardCardProps  ) => {
    ...
    const { mutate: onFavourite, pending: pendingFavourite } = useApiMutation(api.board.favourites);
