...
import { CanvasState, CanvasMode, Camera, Colour, LayerType, Point, XYWH, Side } from "@/types/canvas";
import { useHistory, useCanRedo, useCanUndo, useStorage, useOthersMapped, useSelf } from "@liveblocks/react/suspense";
import { useMutation } from "@liveblocks/react/suspense";
import { CursorsPresence } from "./cursors-presence";
import { colourToCss, connectionIdToColor, findIntersectingLayersWithRectangle, penPointsToPathLayer, pointerEventToCanvasPoint, resizeBounds } from "@/lib/utils";
...
export const Canvas = ({ boardId }: CanvasProps) => {
    ...
    const [ lastUsedColour, setLastUsedColour ] = useState<Colour>({ r: 0, g: 0, b: 0 });
    ...
    return (
        <main className="h-full w-full relative bg-neutral-100 touch-none">
            ...
            <SelectionTools 
                camera={camera}
                setLastUsedColour={setLastUsedColour}
            />
            <svg 
